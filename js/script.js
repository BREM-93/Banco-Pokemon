...
function login() {
  ...
  // Detener la reproducción de la música al navegar a otra página
  ...
  function generarPDF(saldo) {
    ...
    doc.setFontSize(15);
    doc.text('Transacción realizada exitosamente. Nuevo saldo: $' + saldo.toFixed(2), 20, 20);
    ...
    var donutChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: ['#63011B', '#BF0426', '#A60321'],
          borderColor: ['#BF9F9F', '#BF9F9F', '#BF9F9F'],
          borderWidth: 1
        }]
      },
      options: {
